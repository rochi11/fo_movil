<template>
	<GridLayout rows="10, auto" marginBottom="1">
		<Label ref="label" row="1" :text="placeholder" opacity="0.7" fontSize="14" class="input" />
		<TextField ref="textField" :secure="secure" row="1" @focus="onFocus" @blur="onBlur" borderBottomWidth="1" borderBottomColor="#cec8c8"
		 padding="0" />
	</GridLayout>
</template>
